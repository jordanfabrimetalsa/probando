                            ...
                            <form id="formRescue" class="form" method="POST">
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" name="fecha_operativo" id="fecha_operativo" value="{{ old('fecha_operativo') }}"
                                            class="form-control" placeholder="Fecha del Operativo" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Hora del llamado de emergencia</label>
                                        <input type="time" name="hora_llamado" id="hora_llamado" value="{{ old('hora_llamado') }}"
                                            class="form-control" placeholder="Hora del llamado de emergencia" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>RUT/DNI</label>
                                        <input type="text" name="rut_dni" id="rut_dni" value="{{ old('rut_dni') }}" class="form-control"
                                            placeholder="Rut/DNI" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Edad</label>
                                        <input type="number" name="edad" id="edad" value="{{ old('edad') }}" class="form-control"
                                            placeholder="Edad" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Sexo</label>
                                        <select class="form-select border border-gray p-2"
                                            aria-label="Default select example" name="sexo" id="sexo" required>
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="number" name="estatura" id="estatura" value="{{ old('estatura') }}" class="form-control"
                                            placeholder="Estatura" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Peso aproximado (kg)</label>
                                        <input type="number" name="peso" id="peso" value="{{ old('peso') }}" class="form-control"
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-select border border-gray p-2"
                                            aria-label="Default select example" name="condicion_fisica" id="condicion_fisica" required>
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" name="lugar_exacto" id="lugar_exacto" value="{{ old('lugar_exacto') }}"
                                            class="form-control" placeholder="Lugar exacto" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Latitud</label>
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" name="altitud" id="altitud" value="{{ old('altitud') }}" class="form-control"
                                            placeholder="Altitud" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Ubicación de vehículo/s de rescate</label>
                                        <input type="text" name="ubicacion_vehiculo_rescate"
                                            id="ubicacion_vehiculo_rescate" value="{{ old('ubicacion_vehiculo_rescate') }}" class="form-control"
                                            placeholder="Ubicación de vehículo/s de rescate">
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="xabcde_x" id="xabcde_x" class="form-control" value="{{ old('xabcde_x') }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>A - Via Aérea</td>
                                                    <td><input type="text" name="xabcde_a" id="xabcde_a" class="form-control" value="{{ old('xabcde_a') }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>B - Respiración</td>
                                                    <td><input type="text" name="xabcde_b" id="xabcde_b" class="form-control" value="{{ old('xabcde_b') }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>C - Circulación</td>
                                                    <td><input type="text" name="xabcde_c" id="xabcde_c" class="form-control" value="{{ old('xabcde_c') }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>D - Estado Neurológico</td>
                                                    <td><input type="text" name="xabcde_d" id="xabcde_d" class="form-control" value="{{ old('xabcde_d') }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>E - Exposición</td>
                                                    <td><input type="text" name="xabcde_e" id="xabcde_e" class="form-control" value="{{ old('xabcde_e') }}">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="sample_signos_sintomas" id="sample_signos_sintomas" value="{{ old('sample_signos_sintomas') }}" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Alergias</label>
                                        <input type="text" class="form-control" name="sample_alergias" id="sample_alergias" value="{{ old('sample_alergias') }}" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Medicamentos</label>
                                        <input type="text" class="form-control" name="sample_medicamentos" id="sample_medicamentos" value="{{ old('sample_medicamentos') }}" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Patalogías previas</label>
                                        <input type="text" class="form-control" name="sample_patologias_previas" id="sample_patologias_previas" value="{{ old('sample_patologias_previas') }}" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Ultima ingesta</label>
                                        <input type="text" class="form-control" name="sample_ultima_ingesta" id="sample_ultima_ingesta" value="{{ old('sample_ultima_ingesta') }}" required>
                                    </div>
                                    <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                        <label>Eventos previos</label>
                                        <input type="text" class="form-control" name="sample_eventos_previos" id="sample_eventos_previos" value="{{ old('sample_eventos_previos') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <textarea name="resumen_acciones" id="resumen_acciones" class="form-control" placeholder="Resumen de acciones tomadas" required>{{ old('resumen_acciones') }}</textarea>
                                    </div>
                                    <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="material_equipo_bendas"
                                                        name="material_equipo_utilizado[]" value="Bendas">
                                                    <label class="form-check-label">Bendas</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="material_equipo_casco"
                                                        name="material_equipo_utilizado[]" value="Casco">
                                                    <label class="form-check-label">Casco</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="material_equipo_ferula"
                                                        name="material_equipo_utilizado[]" value="Férula">
                                                    <label class="form-check-label">Férula</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="material_equipo_arnes"
                                                        name="material_equipo_utilizado[]" value="Arnés">
                                                    <label class="form-check-label">Arnés</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="material_equipo_botiquin"
                                                        name="material_equipo_utilizado[]" value="Botiquín">
                                                    <label class="form-check-label">Botiquín</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="material_equipo_otros_check"
                                                        name="material_equipo_utilizado[]" value="Otros">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <input type="text" class="form-control" name="material_equipo_otros" id="material_equipo_otros" value="{{ old('material_equipo_otros') }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                                <label>Medicamentos administrados(Medicamento-Dosis-Hora)</label>
                                                <textarea name="medicamentos_administrados" id="medicamentos_administrados" class="form-control" placeholder="Medicamentos administrados">{{ old('medicamentos_administrados') }}</textarea>
                                            </div>
                                            <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <label>Método de evacuación</label>
                                                <select class="form-select border border-gray p-2"
                                                    aria-label="Default select example"
                                                    name="metodo_evacuacion" id="metodo_evacuacion">
                                            ...
                                            <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <select class="form-select border border-gray p-2"
                                                    aria-label="Default select example"
                                                    name="destino_final_paciente" id="destino_final_paciente">
                                                    <option selected>Seleccione el Destino Final del Paciente</option>
                                                    <option value="A pie">Ambulancia</option>
                                                    <option value="Camilla">Traslado particular</option>
                                                    <option value="Vehículo 4x4">Traslado a comisaría por servicio
                                                        médico
                                                        legal</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <textarea name="bitacora_evaluacion_sanitaria_inicial" id="bitacora_evaluacion_sanitaria_inicial" class="form-control" placeholder="Evaluación sanitaria inicial">{{ old('bitacora_evaluacion_sanitaria_inicial') }}</textarea>
                                            </div>
                                            <div class="mb-3 col-lg-4 col-md-4 col-sm-12">
                                            ...
                                            <div class="mb-3 col-lg-8 col-md-8 col-sm-12">
                                                ...
                                                <div id="voluntarySelectContainerVolunteers">
                                                    <div class="row g-2 align-items-end voluntary-select-item">
                                                        <div class="col-12">
                                                            <select
                                                                class="form-select form-select-sm border border-gray p-2"
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                                <textarea name="observaciones_generales" id="observaciones_generales" class="form-control" placeholder="Observaciones generales y recomendaciones">{{ old('observaciones_generales') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
