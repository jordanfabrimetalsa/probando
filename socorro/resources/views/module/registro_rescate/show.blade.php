      ...
      <div class="modal-content modal-extra-background">
        ...
        <div class="modal-body">
          <form id="formRescue" class="form" method="POST">
            ...
            <div class="border mb-4">
                <div class="row p-2">
                    ...
                    <div class="mb-3 col-lg-3 col-md-6 col-sm-12">
                        ...
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="type_show" id="type_show">
                    ...
                    <div class="mb-3 col-lg-3 col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control border border-gray p-2" name="place_show" id="place_show" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3 col-lg-3 col-md-6 col-sm-12">
                        <label for="road" class="form-label">Ruta</label>
                        <input type="text" class="form-control border border-gray p-2" name="road_show" id="road_show" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3 col-lg-3 col-md-6 col-sm-12">
                        <label for="weather" class="form-label">Clima</label>
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="weather_show" id="weather_show">
                ...
                <div class="row p-2">
                    ...
                    <div class="mb-3 col-lg-3 col-md-6 col-sm-12">
                        ...
                        <input type="number" class="form-control border border-gray p-2" name="quantity_voluntaries_show" id="quantity_voluntaries_show" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        <label for="helper_external" class="form-label">Ayuda Externa</label>
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="helper_external_show" id="helper_external_show">
                    ...
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="external_helper_show" id="external_helper_show">
                            <option selected>Seleccione el Ayudante Externo</option>
            ...
            <div class="border mb-4">
                <div class="row p-2">
                    ...
                    <div class="mb-2 col-lg-3 col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control border border-gray p-2" name="name_accident_show" id="name_accident_show" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-2 col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="border mb-4">
                <div class="row p-2">
                    ...
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="datetime-local" class="form-control border border-gray p-2" name="date_call_show" id="date_call_show" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        <label for="date_start_trek" class="form-label">Fecha de Inicio del Rescate</label>
                        <input type="datetime-local" class="form-control border border-gray p-2" name="date_start_trek_show" id="date_start_trek_show" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        <label for="date_middle_trek" class="form-label">Fecha de Encuentro Rescatado</label>
                        <input type="datetime-local" class="form-control border border-gray p-2" name="date_middle_trek_show" id="date_middle_trek_show" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        <label for="date_finish_rescue" class="form-label">Fecha de Finalizacion Rescate</label>
                        <input type="datetime-local" class="form-control border border-gray p-2" name="date_finish_rescue_show" id="date_finish_rescue_show" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="row p-2">
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="medical_assistance_show" id="medical_assistance_show">
                            <option selected>Seleccione </option>
                            <option value="yes">Si</option>
                            <option value="no">No</option>
                        </select>
                    ...
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="Stretcher_show" id="Stretcher_show">
                            <option selected>Seleccione</option>
                            <option value="yes">Si</option>
                            <option value="no">No</option>
                        </select>
                ...
                <div class="row p-2">
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="type_transport_show" id="type_transport_show">
                            <option selected>Seleccione</option>
                    ...
                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <select class="form-select border border-gray p-2" aria-label="Default select example" name="helicopter_show" id="helicopter_show">
                            <option selected>Seleccione</option>
                            <option value="yes">Si</option>
                            <option value="no">No</option>
                        </select>
            ...
            <button type="submit" class="btn btn-success"><i class="fa-solid fa-floppy-disk"></i> Actualizar Rescate</button>
          </form>
        </div>
