        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" data-bs-toggle="collapse" href="#collapseGuard" role="button"
                    ...
                    <i class="fa-solid fa-lock-open opacity-5"></i>
                    <span class="nav-link-text ms-1">Guardia</span>
                </a>
        ...
        <div class="">
            <a class="nav-link gradient-foot-nav text-dark border rounded-3 m-2" href="#">
                @if (!empty($weatherData) && empty($weatherData['error']))
                    <div class="d-flex">
                        <img src="{{ $weatherData['weather'][0]['iconUrl'] }}" width="30" height="30"
                            class="me-2" alt="">
            ...
            <a class="nav-link gradient-foot-nav text-dark border rounded-3 m-2" href="#">
                @if (!empty($weatherDataLaParva) && empty($weatherDataLaParva['error']))
                    <div class="d-flex">
                        <img src="{{ $weatherDataLaParva['weather'][0]['iconUrl'] }}" width="30" height="30"
                            class="me-2" alt="">
                        <div style="font-size: 0.8em">
                            <strong>{{ $weatherDataLaParva['name'] }}</strong><br>
                            <strong>Temperatura:</strong> {{ number_format($weatherDataLaParva['main']['temp'], 0) }}
                            °C
                            <br>
